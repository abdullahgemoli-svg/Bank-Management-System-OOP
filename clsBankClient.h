...
private:
    ...
    static stTransferLogRecord _ConvertTransferLogineToRecord(string Line, string Seperator = "#//#")
    {
        ...
        TransferRecord.Amount = stoi(vTransferLogRecord[3]);
        TransferRecord.srcBalanceAfter= stoi(vTransferLogRecord[4]);
        TransferRecord.destBalanceAfter= stoi(vTransferLogRecord[5]);
    ...
    string UserNaem, string Seperator = "#//#")
    {
...
public:
    ...
    static vector <stTransferLogRecord> GetTransferLogList()
    {
        ...
        if (MyFile.is_open())
        {
            ...
            while (getline(MyFile, Line))
            {
                TransferRecord = _ConvertTransferLogineToRecord(Line);
